...
$sql_cms="select * from home_page WHERE id=$id"; 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify Home Page Content Change- ".$row_cms['title'];
			  }
			  else
			  {
				echo "Add Home Content";  
			  }
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify Home Page- ".$row_cms['title'];
			  }
			  else
			  {
				echo "Add Home Page";  
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="homepage_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                    ...
                    <label for="exampleInputEmail1">Photo Two</label>
                     ...
                     <div class="form-group">
                      ...
                      <textarea name="iframe" class="form-control"><?php echo $row_cms['iframe']; ?></textarea>
