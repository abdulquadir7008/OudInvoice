...
$sql_cms="select * from banner WHERE id=$id"; 
 ...
 $sub2="Save";
  ...
  <aside class="right-side"> 
    ...
    <section class="content-header">
      <h1> Manage Slider <small>Content Managment System</small> </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">CMS</a></li>
        <li class="active"><?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify Slider- ".$row_cms['title'];
			  }
			  else
			  {
				echo "Add Slider";  
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify Testimonial- ".$row_cms['title'];
			  }
			  else
			  {
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="banner_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Heading</label>
                      <input type="text" name="heading" class="form-control" id="exampleInputEmail1" placeholder="Enter heading" value="<?php echo $row_cms['heading']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						 ...
						 <input type="text" name="date" class="form-control" value="<?php echo $row_cms['date']; ?>" />
