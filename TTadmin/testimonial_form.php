...
$sql_cms="select * from service WHERE id=$id"; 
 ...
 $sub2="Save";
  ...
  <aside class="right-side"> 
    ...
    <section class="content-header">
      <h1> Manage Testimonial <small>Content Managment System</small> </h1>
      <ol class="breadcrumb">
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="testimonial_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                                        <label>City</label>
                                            ...
                                            <input type="text" name="city" class="form-control" placeholder="City" value="<?php echo $row_cms['city']; ?>" />
                                       <!-- /.input group -->
                                    </div>
