    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(isset($_REQUEST['cms'])) { 
			  echo "Modify category- ".$row_cms['title'];
			  }
			  else
			  {
				echo "Add category";  
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="category_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="timing" class="form-control" id="exampleInputEmail1" placeholder="Enter Title" value="<?php echo $row_cms['timing']; ?>">
                    </div>
