...
$query="update service SET title='$title',seo_keyword='$sekey2',content='$content', date=now(),sortorder='$sortorder',city='$city',image='$image0' WHERE id=$id";
...
{
$query="insert into service(title,seo_keyword,content,date,sortorder,city,status,image) values('$title','$sekey2','$content',now(),'$sortorder','$city','1','$image0')";
mysqli_query($link,$query);
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pages List for Testimonial</h3>
              <a href="testimonial_form.php">
...
$sql_cms="select * from service order by sortorder ASC"; 
...
?>
                    <tr>
                      ...
                      <td><a href="testimonial_form.php?cms=<?php echo $row_cms['id'];?>" class="edit_btn"><span>Edit</span></a>
                        <?php if($row_cms['status']==1){ ?>
                        <span><a href="testimonial_manage.php?id=<?php echo $row_cms['id']; ?>" title="Active" class="active"><span>ac</span></a></span>
                        <?php } else { ?>
                        <span><a href="testimonial_manage.php?id1=<?php echo $row_cms['id']; ?>" title="Inactive" class="inact"><span>in</span></a></span>
                        <?php } ?>
                        <span><a href="testimonial_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
