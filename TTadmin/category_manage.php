...
$query="update category SET title='$title',seo_keywords='$sekey2', date=now(),sortorder='$sortorder',image='$image0',timing='$timing' WHERE id=$id";
...
{
$query="insert into category(title,seo_keywords,date,sortorder,status,image,timing) values('$title','$sekey2',now(),'$sortorder','1','$image0','$timing')";
mysqli_query($link,$query);
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pages List for Category</h3>
...
$sql_cms="select * from category order by sortorder ASC"; 
...
?>
                    <tr>
                      ...
                      <td><a href="category_form.php?cms=<?php echo $row_cms['id'];?>" class="edit_btn"><span>Edit</span></a>
                        <?php if($row_cms['status']==1){ ?>
                        <span><a href="category_manage.php?id=<?php echo $row_cms['id']; ?>" title="Active" class="active"><span>ac</span></a></span>
                        <?php } else { ?>
                        <span><a href="category_manage.php?id1=<?php echo $row_cms['id']; ?>" title="Inactive" class="inact"><span>in</span></a></span>
                        <?php } ?>
                        <span><a href="category_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
