...
$query="update banner SET title='$title',heading='$heading',seo_keyword='$seokeyword',content='$content', date='$date',sortorder='$sortorder',image='$image0' WHERE id=$id";
...
{
$query="insert into banner(title,heading,seo_keyword,content,date,sortorder,image,status) values('$title','$heading','$seokeyword','$content','$date','$sortorder','$image0','1')";
mysqli_query($link,$query);
...
document.frmUser.action = "script/all-delatebanner.php";
document.frmUser.submit();
}
}
function setInactiveAction() {
document.frmUser.action = "script/allinactivebanner.php";
document.frmUser.submit();
}
function setActiveAction() {
document.frmUser.action = "script/activebanner.php";
document.frmUser.submit();
}
</script>
</head>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pages List for Slider</h3>
              <a href="banner_form.php">
...
$sql_cms="select * from banner order by sortorder ASC"; 
...
?>
      ...
      <?php } ?>
                      ...
                      <td><a href="banner_form.php?cms=<?php echo $row_cms['id'];?>" class="edit_btn"><span>Edit</span></a>
                        <?php if($row_cms['status']==1){ ?>
                        <span><a href="banner_manage.php?id=<?php echo $row_cms['id']; ?>" title="Active" class="active"><span>ac</span></a></span>
                        <?php } else { ?>
                        <span><a href="banner_manage.php?id1=<?php echo $row_cms['id']; ?>" title="Inactive" class="inact"><span>in</span></a></span>
                        <?php } ?>
                        <span><a href="banner_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
