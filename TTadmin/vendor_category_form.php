...
$sql_cms="select * from vendor_category WHERE id=$id"; 
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="vendor_category_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                  
                   
                    <div class="form-group">
                      <label for="exampleInputEmail1"> Vendor Category Name</label>
                      <input type="text" name="vendor_category_name" class="form-control" id="exampleInputEmail1" placeholder="Enter vendor_category_name" value="<?php echo $row_cms['vendor_category_name']; ?>">
                    </div>
