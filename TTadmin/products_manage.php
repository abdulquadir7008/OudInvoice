...
$star=$_REQUEST['star'];
$seokeyword = str_replace(str_split('&\\/:*?"<>| '), '_', $title);
...
$query="update products SET title='$title',seo_keywords='$sekey2', date=now(),sortorder='$sortorder',image='$image0',star='$star',category_id='$category_id',price='$price' WHERE id=$id";
...
{
$query="insert into products(title,seo_keywords,date,sortorder,status,image,star,category_id,price) values('$title','$sekey2',now(),'$sortorder','1','$image0','$star','$category_id','$price')";
mysqli_query($link,$query);
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pages List for Product</h3>
...
$sql_cms="select * from products order by sortorder ASC"; 
...
?>
                    <tr>
                      ...
                      <td><?php 
												...
												?></td>
                      <td><img src="../uploads/<?php echo $row_cms['image'];?>" width="60"></td>
                      <td><a href="products_form.php?cms=<?php echo $row_cms['id'];?>" class="edit_btn"><span>Edit</span></a>
                        <?php if($row_cms['status']==1){ ?>
                        <span><a href="products_manage.php?id=<?php echo $row_cms['id']; ?>" title="Active" class="active"><span>ac</span></a></span>
                        <?php } else { ?>
                        <span><a href="products_manage.php?id1=<?php echo $row_cms['id']; ?>" title="Inactive" class="inact"><span>in</span></a></span>
                        <?php } ?>
                        <span><a href="products_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
