...
$sql_cms="select * from sent where status='1' order by id DESC"; 
                                        ...
                                        <div class="col-md-3 col-sm-4">
                                            ...
                                            <div style="margin-top: 15px;">
                                                <ul class="nav nav-pills nav-stacked">
                                                    ...
                                                    <li><a href="started.php"><i class="fa fa-star"></i> Starred (<?php echo mysqli_num_rows($result_star);?>)</a></li>
...
<td class="name"><a href="mailbox_details.php?id=<?php echo $row_cms['id'];?>&&<?php echo $row_cms['session'];?>"><?php echo $row_cms['email']; ?></a></td>
...
<td class="time"><?php echo date("H:m, d-m-Y",$row_cms['date']); ?></td>
</tr>
                                                  <?php
												  }
												  ?>
