...
foreach($recipients as $email => $name){
	...
	$mail->MsgHTML("<b>Hi, your first Newsletter mail through SMTP has been received. Great Job!.. <br/><br/>by <a href='https://www.asif18.com/7/php/send-mails-using-smtp-in-php-by-gmail-server-or-own-domain-server/'>Asif18</a></b>"); //Put your body of the message you can place html code here
