...
$sql_cms="select * from vendor_registration_type WHERE venreg_id=$id"; 
 ...
 ?> 
            ...
            <div class="box-body table-responsive">
              <div class="box box-primary"> 
                ...
                <form action="vendor_registration_type_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
                  <div class="box-body">
                  
                   
                    <div class="form-group">
                      <label for="exampleInputEmail1"> Vendor Registration Name</label>
                      <input type="text" name="vendor_registration_name" class="form-control" id="exampleInputEmail1" placeholder="Enter vendor_registration_name" value="<?php echo $row_cms['vendor_registration_name']; ?>">
                    </div>
...
-->
                  ...
                  <div class="box-footer">
                    <input type='hidden' name='venreg_id' id='id' maxlength="50"   size="30" value="<?php echo $row_cms['venreg_id']; ?>"/>
