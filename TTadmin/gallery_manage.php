...
$query="update gallery2 SET image='$image0' WHERE id=$id";
...
{
$query="insert into gallery2(image,status) values('$image0','1')";
mysqli_query($link,$query);
...
$query="update gallery2 SET status='$status' WHERE id='$id'";         
mysqli_query($link,$query);
}
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All pages List for News & Article</h3>
              <form action="gallery_manage.php" method="post" enctype="multipart/form-data" name="cont"  id="myform" onSubmit="return validate();">
...
$sql_cms="select * from gallery2 order by id DESC"; 
...
?>
                    <tr>
                      ...
                      <td>
                        ...
                        <span><a href="gallery_manage.php?id=<?php echo $row_cms['id']; ?>" title="Active" class="active"><span>ac</span></a></span>
                        <?php } else { ?>
                        <span><a href="gallery_manage.php?id1=<?php echo $row_cms['id']; ?>" title="Inactive" class="inact"><span>in</span></a></span>
                        <?php } ?>
                        <span><a href="gallery_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
