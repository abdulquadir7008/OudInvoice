...
$vendorer_type_name=$_REQUEST['vendorer_type_name'];

if(isset($_REQUEST['update']))
{

$id = $_REQUEST['id'];
$query="update vendor_type SET vendorer_type_name='$vendorer_type_name' WHERE id=$id";
...
{
$query="insert into vendor_type(vendorer_type_name) values('$vendorer_type_name')";
mysqli_query($link,$query);
...
$query="update vendor_type SET status='$status' WHERE id='$id'";         
mysqli_query($link,$query);
}
else if(isset($_REQUEST['del']))
{
$id=$_REQUEST['del'];
$query="delete from vendor_type WHERE id=$id";
mysqli_query($link,$query);
}
?>
...
$sql_cms="select * from vendor_type order by vendorer_type_name ASC"; 
...
?>
                    <tr>
                      ...
                      <td><?php 
												...
												echo $row_cms['vendorer_type_name'];
												
												?></td>
                     
                      <td><a href="vendor_type_form.php?cms=<?php echo $row_cms['id'];?>" class="edit_btn"><span>Edit</span></a>
                        
                        <span><a href="vendor_type_manage.php?del=<?php echo $row_cms['id']; ?>" onClick="return confirm('Do you really want to remove it?')" class="delet"><span>Delete</span></a></span></td>
                    </tr>
