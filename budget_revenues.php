...
$revenue_date = $_REQUEST['revenue_date'];
...
$querybord="insert into budget_revenue (noted,amount,revenue_date,category,image,status) values('$noted','$amount','$revenue_date','$category','$image0','1')";
...
$query="update budget_revenue SET noted='$noted',amount='$amount',revenue_date='$revenue_date',category='$category',image='$image0' WHERE revenue_id=$revenue_id";
...
{
$del=$_REQUEST['del'];
$query="delete from budget_revenue WHERE revenue_id=$del";
mysqli_query($link,$query);
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table mb-0">
									...
									<tbody>
										<?php
										$k = 1;
										$SQDepart="select * from budget_revenue WHERE status='1' order by revenue_id DESC";
										...
										<tr>
					                        ...
					                        <td><?php echo $ListDepart['amount'];?></td>
                       						<td><?php echo $ListDepart['revenue_date'];?></td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_categories<?php echo $ListDepart['revenue_id'];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
														<a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete<?php echo $ListDepart['revenue_id'];?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
													</div>
												</div>
											</td>
										</tr>
										
										<div class="modal custom-modal fade" id="edit_categories<?php echo $ListDepart['revenue_id'];?>" role="dialog">
				    <div class="modal-dialog modal-dialog-centered" role="document">
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
								<form method="post" action="budget_revenues.php" enctype="multipart/form-data">
				                <div class="form-group form-row">
				                    ...
				                    <div class="col-lg-12">
				                        <input class="datetimepicker form-control" type="text" name="revenue_date" value="<?php echo $ListDepart['revenue_date'];?>">
				                    </div>
				                    </div>
				                </div>
				                <div class="form-group form-row">
                      ...
                      <?php }?>
				                ...
				                <div class="submit-section">
									<input type="hidden" name="revenue_id" value="<?php echo $ListDepart['revenue_id'];?>">
				                    <button name="update" type="submit" class="btn btn-primary submit-btn">Update</button>
										...
										<div class="modal custom-modal fade" id="delete<?php echo $ListDepart['revenue_id'];?>" role="dialog">
						...
						<div class="modal-content">
							<div class="modal-body">
								...
								<div class="modal-btn delete-action">
									<div class="row">
										<div class="col-6">
											<a href="budget_revenues.php?del=<?php echo $ListDepart['revenue_id'];?>" class="btn btn-primary continue-btn">Delete</a>
										</div>
										<div class="col-6">
				        ...
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
				                ...
				                <div class="form-group form-row">
				                    ...
				                    <div class="col-lg-6">
				                         <label class="col-lg-12 control-label">Revenues Date <span class="text-danger">*</span></label>
				                    <div class="col-lg-12">
				                        <input class="datetimepicker form-control" type="text" name="revenue_date">
				                    </div>
				                    </div>
				                </div>
				                <div class="form-group form-row">
