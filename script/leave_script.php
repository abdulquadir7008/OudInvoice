...
date_to='$date_to',leave_reason='$leave_reason',image3='$image0' WHERE leave_id=$leave_id";
mysqli_query($link,$query);
...
{
$querybord="insert into leave_tbl (user_employee,leave_type,date_from,date_to,leave_reason,lb_status,image3) 
values('$user_employee','$leave_type','$date_from','$date_to','$leave_reason','1','$image0')";
